...
const Programacao = () => {
  ...
  useEffect(() => {
    ...
    const loadDefaults = () => {
      ...
      // We no longer set a fallback schedule. If no data is found, days remains [].
      setDays([]);
    };
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          {days.length === 0 ? (
            <motion.div
              ...
              className="mt-12 p-12 bg-primary/5 border-2 border-dashed border-primary/20 rounded-[3rem] text-center"
            >
              <h3 className="text-3xl md:text-5xl font-heading font-black text-primary uppercase tracking-[0.2em] mb-4">
                EM PLANEJAMENTO
              </h3>
              <p className="text-lg text-muted-foreground font-medium max-w-2xl mx-auto">
                Estamos preparando cada detalhe da agenda do IX CONTEFFA para oferecer a melhor experiência técnica e profissional possível.
              </p>
            </motion.div>
          ) : (
